...
ResponseCharacters responseCharactersFromJson(String str) =>
    ResponseCharacters.fromJson(json.decode(str));

String responseCharactersToJson(ResponseCharacters data) =>
